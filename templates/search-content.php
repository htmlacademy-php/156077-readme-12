          ...
          <div class="container">
            <div class="search__content">
                <?php foreach ($postsData as $postIndex => $post) : ?>
                    <article class="search__post post <?= $post['type_name']; ?>">
                        ...
                        <a class="post__author-link" href="#" title="Автор">
                            ...
                            <span class="post__time"><?= getRelativeDateDifference(new DateTime($post['create_date']), 'назад'); ?></span>
                            </div>
                        </a>
                        </header>
                        <div class="post__main">
                            <?php if ($post['type_name'] == 'post-photo') : ?>
                                ...
                                <div class="post-photo__image-wrapper">
                                    <img src="<?= checkFilePath($post['post_image']); ?>" alt="Фото от пользователя" width="760" height="396">
                                </div>
