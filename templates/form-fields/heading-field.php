...
<div class="form__input-section <?= (isset($formFieldsError[$formType]) && isset($formFieldsError[$formType]['form-heading']) && $formFieldsError[$formType]['form-heading'] != 'success') ? 'form__input-section--error' : '';?>">
    <input class="adding-post__input form__input" id="form-heading" type="text" name="form-heading" placeholder="Введите заголовок" value="<?= ($postRequestData['form-heading']) ? $postRequestData['form-heading'] : ''; ?>">
