      ...
      <div class="page__main-wrapper page__main-wrapper--intro container">
        ...
        <section class="authorization">
          ...
          <form class="authorization__form form" action="#" method="post">
            <div class="authorization__input-wrapper form__input-wrapper form__input-section--error">
              <input class="authorization__input authorization__input--login form__input" type="text" name="login" placeholder="Логин" value="<?= $postRequestData['login'];?>">
              <svg class="form__input-icon" width="19" height="18">
                <use xlink:href="#icon-input-user"></use>
              </svg>
              <label class="visually-hidden">Логин</label>           
            </div>
            <span class="form__error-label form__error-label--login"><?= ($formFieldsError['authentification']['login'] != 'success') ? $formFieldsError['authentification']['login'] : '';?></span>
            <div class="authorization__input-wrapper form__input-wrapper form__input-section--error">
